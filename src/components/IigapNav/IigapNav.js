...
import { findMenuByLocation, MENU_LOCATION_NAVIGATION_DEFAULT, findMenuById } from 'lib/menus';

import Section from 'components/Section';

import styles from './IigapNav.module.scss';
...
const IigapNav = () => {
  ...
  const menuId = 2;
  const singlemenu = findMenuById(menuId);
